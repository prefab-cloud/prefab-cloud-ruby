...
# -*- encoding: utf-8 -*-
# stub: prefab-cloud-ruby 0.0.4 ruby lib
...
Gem::Specification.new do |s|
  ...
  if s.respond_to? :specification_version then
    ...
    if Gem::Version.new(Gem::VERSION) >= Gem::Version.new('1.2.0') then
      ...
      s.add_runtime_dependency(%q<openssl>.freeze, ["~> 2.1"])
      s.add_runtime_dependency(%q<jruby-openssl>.freeze, ["~> 0.9.4"])
      ...
      s.add_dependency(%q<jruby-openssl>.freeze, ["~> 0.9.4"])
